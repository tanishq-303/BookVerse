...
const Signup = () => {
  ...
  <div className="modal-box">
    ...
    <div className='flex justify-around mt-4'>
        ...
        { <p className='text-xl'>Already a User? <button className='underline text-blue-500 cursor-pointer' onClick={()=>{document.getElementById("my_modal_3").showModal()}}>Login</button>
        <Login /></p> }
    </div>
