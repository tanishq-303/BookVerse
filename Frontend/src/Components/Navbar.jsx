...
const Navbar = () => {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-10 6h16" /></svg>
      </div>
  ...
  {/* moon icon */}
  <svg className="swap-on fill-current w-7 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" onClick={()=>setTheme(theme==="dark"?"light":"dark")}><path d="M21.64,13a1,1,0,0,0-1.05-.14,10.05,10.05,0,0,1-3.37.73A8.15,10.15,0,0,1,9.08,5.49a8.59,10.59,0,0,1,.25-2A1,1,0,0,0,10,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,10.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,10.11,0,0,1,12.14,19.73Z"/></svg>
